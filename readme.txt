...
===============================================================================
	...
	3. driver/
		3.1 rtl8192EU_linux_v4.3.1.1_11320.20140505.tar.gz
			Naming rule: rtlCHIPS_linux_vM.N.P.H_sssss.yyyymmdd.tar.gz
			where:
	...
	4. wpa_supplicant_hostapd/
	  ...
	  4.5 wpa_supplicant_hostapd-0.8_rtw_r7475.20130812.tar.gz
		...
		4.8 wpa_supplicant_8_jb_4.3_rtw_r9301.20131011.tar.gz
			 wpa_supplicant_8 from Android 4.3 SDK and patched by Realtek
			 could be used for Android 4.3. Support only cfg80211/nl80211.
			 
		4.9 wpa_supplicant_8_kk_4.4_rtw_r10450.20140220.tar.gz
			 wpa_supplicant_8 from Android 4.4 SDK and patched by Realtek
			 could be used for Android 4.4. Support only cfg80211/nl80211.	 
	...
	7. android_reference_codes/
		7.1 realtek_wifi_SDK_for_android_20120618.tar.gz
			This tar ball includes our android wifi reference codes for Android 2.3
	...
	12. android_ref_codes_JB_4.4
		12.1 linux-3.0.42_STATION_INFO_ASSOC_REQ_IES.diff
			Kernel patch file for cfg80211's STATION_INFO_ASSOC_REQ_IES event for kernel 3.0.

		12.2 realtek_wifi_SDK_for_android_KK_4.4_20140117.tar.gz
			This tar ball includes our android wifi reference codes for Android 4.4

		12.3 Realtek_Wi-Fi_SDK_for_Android_KK_4.4.pdf
